...
VALUES 
(DEFAULT, 'Greystone', 'Cat', 'M', 'Domestic Shorthair', '2021-08-18', '2021-09-18', 'Greystone and his four siblings were left in a box outside an office building. But they made it to us and oh how their lives have changed! Greystone loves to eat, loves to wrestle, loves treats, loves toys.', 'Greystone.jpg'),
...
(DEFAULT, 'Cookie', 'Cat', 'M', 'Domestic Shorthair', '2021-06-05', '2021-07-25', 'Give your paws up for Cookie, the sassiest little kitten you will ever meet! Cookie is a male kitten with a very strong personality! Cookie will not hold back his opinions (very vocal) and likes to show off!', 'Cookie.jpg'),
(DEFAULT, 'Moe', 'Cat', 'M', 'Domestic Shorthair', '2021-01-25', '2021-08-25', 'This big tabby boy with the striking yellow eyes is one big softie! He is a big fan of his human caretakers, and often will rub up against their legs and follow them around the suite. He is a very social guy, but a laid-back sort, as well.', 'Moe.jpg'),
...
(DEFAULT, 'Bonita', 'Cat', 'F', 'Domestic Shorthair','2014-02-21', '2021-03-21', 'Bonita is a sweet, vocal lady seeking a comfy spot to chill in. She is used to being the queen of whatever space she is in, and she would greatly enjoy a calm home away from all the crazy kitten energy and with plenty of spaces to rest. This beautiful gray and white girl likes attention.', 'Bonita.jpg'),
(DEFAULT, 'Trick', 'Cat', 'F', 'Domestic Shorthair', '2021-08-28', '2021-09-28', 'My foster mommy says I was the first kitten in the litter to purr and as of today, I was the first in the litter to lay in her lap. I''m trusting, outgoing and very lovable.', 'Trick.jpg'),
(DEFAULT, 'Treat', 'Cat', 'F', 'Domestic Shorthair','2021-08-28', '2021-09-28', 'My foster mommy thinks I am adorable because I go into a state of nirvana when she gives me belly rubs. When she is on the floor with us, I do all I can to get her attention for more belly rubs!', 'Treat.jpg'),
(DEFAULT, 'Elliot', 'Dog', 'M', 'Cattle Dog', '2017-08-16', '2021-09-16', 'Elliot is a beautiful, playful boy that loves people (including kids!) and does well with other dogs. Elliot came to us from a backyard breeding situation, but he''s put that behind him and looks forward to finding his furever home.', 'Elliot.jpg'),
(DEFAULT, 'Rex', 'Dog', 'M', 'Chihuahua-Mix', '2019-05-20', '2021-06-20', 'Rex came to us from a hoarding case, and as a result is very fearful. The good news, however, is that Rex absolutely loves peanut butter... so an adopter who has some patience and unlimited peanut butter is likely to win Rex over!', 'Rex.jpg'),
(DEFAULT, 'Autumn', 'Dog', 'F', 'Mixed Breed', '2019-03-31', '2021-04-30', 'Autumn is a beautiful young lady that loves to gallop around the yard and go for walks, followed by snuggles on the couch. She is a medium energy dog that is housebroken and would be happy in an apartment or a house, as long as there''s someone to give her lots of love.', 'Autumn.jpg'),
(DEFAULT, 'Nash', 'Dog', 'M', 'Husky-Mix', '2017-04-28', '2021-05-28', 'We are proud to be representing Nash in his search for a forever home. He has proven to be okay with cats and good with kids. He is, however, not particularly fond of other dogs so he needs to be the only dog in his new home.', 'Nash.jpg'),
(DEFAULT, 'Waldo', 'Dog', 'M', 'Retriever-Lab Mix', '2020-02-22', '2021-03-22', 'Waldo is a very charming, sweet dog with soulful eyes. He loves people and gets along with other dogs. For a young dog, he is very laid back. He loves to play fetch, but he''s also happy just lounging in the sunshine with a toy.', 'Waldo.jpg'),
...
(DEFAULT, 'Beebee', 'Dog', 'F', 'Retriever-Lab Mix', '2019-09-28', '2021-10-28', 'BeeBee is a sweet and intelligent dog recently returned to us due to no fault of her own. BeeBee would love a new family that can get her outdoors on regular basis so she can fully embrace being a dog and go on adventures!', 'Beebee.jpg'),
(DEFAULT, 'Wylie', 'Dog', 'M', 'Hound-Mix', '2015-06-16', '2021-07-16', 'Wylie has come back to us because his previous adopters had a change in living conditions that were not in Wylie''s best interest. They loved Wylie and tried everything they could to ensure that he would do well in his new accommodations, but Wylie needed more space.', 'Wylie.jpg'),
(DEFAULT, 'Alphonzo', 'Dog', 'M', 'Bulldog-Mix', '2014-02-13', '2021-03-13', 'Alfonzo P is a character who definitely has his own opinions about things! He enjoys being out in the play yard and he also enjoys nap time. He is one of the lucky homeless dogs that were transported by a rescue group in Puerto Rico to us so that they could find forever homes.', 'Alphonzo.jpg'),
(DEFAULT, 'London', 'Dog', 'F', 'Mixed Breed', '2015-05-28', '2021-06-28', 'London came to us severely malnourished with a litter of puppies. Her puppies are grown and adopted, and now London is healthy and ready for her own forever home. She is incredibly sweet and loves people of all ages, including kids!', 'London.jpg'),
(DEFAULT, 'Bugs', 'Bunny', 'M', 'American Chinchilla', '2018-02-19', '2021-03-19', 'Bugs was rescued from a farm. He''s a chubby little guy who loves to cuddle!', 'Bugs.jpg'),
